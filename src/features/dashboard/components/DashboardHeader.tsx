    ...
    <header className="flex h-16 shrink-0 items-center justify-between border-b px-4 md:px-5">
      <div className="flex items-center gap-4">
        ...
        <Select defaultValue={selectedPointTitle}>
          <SelectTrigger className="h-9 border-none bg-transparent px-0 text-sm font-medium text-foreground shadow-none focus-visible:ring-0">
      ...
      <div className="flex items-center gap-3">
        <Button
          size="icon"
          variant="outline"
          className="size-10 rounded-md border-border bg-background text-foreground hover:bg-accent [&_svg]:size-4"
        ...
        <div className="relative">
          ...
          <span className="bg-destructive absolute top-0 right-0 h-2.5 w-2.5 rounded-full" />
        </div>
        ...
        <div className="group relative ml-6">
          ...
          >
            <Avatar className="rounded-md border bg-muted">
            ...
            <div>
              ...
              <p className="text-muted-foreground">{userRoleTitle}</p>
            </div>
          </button>
